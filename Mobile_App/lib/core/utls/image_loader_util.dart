...
import 'package:kaashtkart/core/utls/image_skeleton.dart';
...
class ImageLoaderUtil {
  ...
  static Widget cacheNetworkImage(String imageUrl, {double? width, double? height, BoxFit fit = BoxFit.cover, String? errorWidget}) {
